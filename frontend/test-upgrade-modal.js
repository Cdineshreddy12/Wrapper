...
async function testUpgradeModal() {
  ...
  try {
    ...
    const validationRules = {
      ...
      adminRole: {
        required: true,
        validValues: ['Super Administrator', 'Administrator', 'Manager', 'User']
      }
    };
    ...
    const userFlow = [
      ...
      '3. User fills GSTIN and team emails',
      ...
      '8. User clicks Next -> Step 4 (Admin Setup)',
      '9. User fills admin details',
      '10. User clicks Complete Upgrade',
      '11. Form validates all data',
      '12. API call made to backend',
      '13. Success message shown',
      '14. Modal closes',
      '15. User redirected to payment'
    ];
