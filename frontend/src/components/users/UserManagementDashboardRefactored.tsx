...
import { StatusBadge, UserStatusBadge } from '@/components/ui/status-badge';
...
export function UserManagementDashboardRefactored() {
  ...
  const actions: DataTableAction<User>[] = [
    ...
    },
    {
      ...
      icon: Crown,
      onClick: (user) => handlePromoteUser(user.userId, user.name),
    ...
    },
    {
      ...
      disabled: (user) => user.onboardingCompleted
    },
    {
      key: 'delete',
      label: 'Delete User',
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => setEditForm(prev => ({ ...prev, isTenantAdmin: checked as boolean }))}
              />
