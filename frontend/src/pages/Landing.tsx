    ...
    if (isAuthenticated) {
      ...
      try {
        ...
        if (isInvitedUser) {
          ...
          console.log(
            "✅ Invited user detected, redirecting to dashboard (skipping onboarding)"
          );
          navigate("/dashboard", { replace: true });
          return;
        }
        ...
        console.log(
          "ℹ️ Could not check auth status, proceeding with onboarding"
        );
      }
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 pb-16">
          ...
          <div className="text-center mb-16 max-w-5xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                All-in-one business management platform that scales with your
                team. From project management to analytics, permissions to
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              <div className="text-center p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300">
                ...
                <p className="text-sm text-gray-600">
                  Advanced role-based permissions and user management
                </p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300">
              ...
              <div className="text-center p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300">
                ...
                <p className="text-sm text-gray-600">
                  Bank-level security with SSO integration
                </p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300">
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="p-8 hover:shadow-2xl transition-all duration-300 bg-white/80 backdrop-blur-sm border-green-200 relative overflow-hidden group">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="font-medium">
                        Secure authentication with Kinde SSO
                      </span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                      ...
                      <span className="font-medium">
                        Instant access to team workspace
                      </span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                      ...
                      <span className="font-medium">
                        All your projects and data ready
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-700">
                          Automatically detects your organizations or lets you
                          choose from multiple teams.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700">
                          Ideal for startups, growing businesses, and teams
                          switching platforms. Setup takes less than 3 minutes!
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl mx-auto mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Everything your growing business needs, integrated seamlessly
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-white/50 hover:bg-white/90 transition-all duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Granular permissions system with role-based access control
                </p>
                <ul className="text-sm text-gray-500 space-y-2">
                  <li className="flex items-center">
                    <CheckCircle className="w-4 h-4 mr-2 text-green-500" />
                  ...
                  <div className="text-left bg-green-50 rounded-xl p-6 border border-green-100">
                    ...
                    <ul className="text-green-700 space-y-2">
                      <li className="flex items-start space-x-2">
                        ...
                        <span>
                          Someone invited you to join their organization
                        </span>
                      </li>
                      <li className="flex items-start space-x-2">
                        <CheckCircle className="w-4 h-4 mt-1 text-green-600" />
