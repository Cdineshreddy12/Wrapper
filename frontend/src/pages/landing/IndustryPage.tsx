        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center">
                    ...
                    <button onClick={() => navigate('/')} className="text-blue-600 hover:text-blue-700 font-medium">Return to Home</button>
                </div>
            </div>
        );
    }
            ...
            <Navbar>
                <NavBody>
                    ...
                    <div className="flex items-center gap-3 shrink-0 ml-4">
                         <NavbarButton variant="outline" onClick={() => navigate('/')} as="button" className="rounded-xl px-5 py-2">
                            Home
                        </NavbarButton>
                        <NavbarButton variant="gradient" onClick={() => navigate('/onboarding')} as="button" className="rounded-xl px-5 py-2 shadow-lg shadow-blue-500/20">
                            Start Free Trial
                        </NavbarButton>
                    </div>
                </NavBody>
                <MobileNav>
                    ...
                    <MobileNavMenu isOpen={true} onClose={() => {}}>
                         ...
                         <div className="flex w-full flex-col gap-3 mt-4">
                            <NavbarButton onClick={() => { setIsMobileMenuOpen(false); navigate('/onboarding'); }} variant="gradient" className="w-full rounded-xl" as="button">
                                Start Free Trial
                            </NavbarButton>
                        </div>
                    </MobileNavMenu>
