...
export function UserManagementModals() {
  ...
  return (
    <>
      {/* User Details Modal - Removed, now using page route */}
      ...
      <RoleAssignmentModal
        ...
        isLoading={userMutations.assignRoles.isPending}
        isDeassigning={userMutations.deassignRole.isPending}
      />
      ...
      <EditUserModal
        ...
        isLoading={userMutations.updateUser.isPending}
      />
      ...
      <DeleteUserModal
        ...
        isLoading={userMutations.deleteUser.isPending}
      />
