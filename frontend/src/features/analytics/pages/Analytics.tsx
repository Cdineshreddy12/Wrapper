        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <ChartCard
              ...
              description="Daily usage (credits) for the selected period"
              ...
              emptyTitle="No usage data available"
              emptyDescription="Usage data will appear here once it's available for the selected period."
              emptyAction={
