...
class CRMConsumer {
   ...
   * DISABLED: Redis removed, using AWS MQ consumer instead
   */
  async subscribeToChannels() {
    console.log('⚠️ Redis subscription disabled - using AWS MQ consumer instead');
    console.log('   Please use amazon-mq-consumer.js for message consumption');
    // Redis removed - AWS MQ consumer handles message consumption
  }
  ...
  async shutdown() {
    try {
      // Redis removed - no cleanup needed
      console.log('🛑 CRM consumer shutdown successfully (Redis removed, using AWS MQ)');
