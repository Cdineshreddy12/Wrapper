...
class CRMSpecificSyncService {
   ...
   * DISABLED: Redis removed, using AWS MQ publisher instead
   */
  async publishToRedis(channel, event) {
    console.log('⚠️ Redis publishing disabled - using AWS MQ publisher instead');
    // Redis removed - use AWS MQ publisher for messaging
  }
